...
game.Players.LocalPlayer.OnTeleport:Connect(function(State) if State == Enum.TeleportState.Started then if q then q("loadstring(game:HttpGet('https://raw.githubusercontent.com/smorettii/.lua/main/mm22.lua'))()") end end end)
